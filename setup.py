...
setup(
  name = 'Topsis_Keshav_102017064',         # How you named your package folder (MyLib)
  packages = ['Topsis_Keshav_102017064'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/keshavgarg23/Topsis-Keshav-102017064/archive/refs/tags/v.01.tar.gz',    # I explain this later on
